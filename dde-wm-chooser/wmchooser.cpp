    ...
    : QWidget(parent)
{
    ...
    QLabel*tip = new QLabel(tr("It has detected that you are using a virtual machine, termux or tiny computer, which will affect the system performance and operation experience, for a smooth experience, Normal Mode is recommended"));
